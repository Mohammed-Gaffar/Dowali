...
using Dowali.Infrastructure.Repositories;
...
builder.Services.AddDbContext<DowaliContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection")));
